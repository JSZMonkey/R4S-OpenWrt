...
# qBittorrent 下载
svn checkout https://github.com/coolsnowwolf/luci/trunk/applications/luci-app-qbittorrent ./package/new/luci-app-qbittorrent
svn checkout https://github.com/coolsnowwolf/packages/trunk/net/qBittorrent-static ./package/new/qBittorrent-static
svn checkout https://github.com/coolsnowwolf/packages/trunk/net/qBittorrent ./package/new/qBittorrent
svn checkout https://github.com/coolsnowwolf/packages/trunk/libs/qtbase ./package/new/qtbase
svn checkout https://github.com/coolsnowwolf/packages/trunk/libs/qttools ./package/new/qttools
svn checkout https://github.com/coolsnowwolf/packages/trunk/libs/rblibtorrent ./package/new/rblibtorrent
