...
mv ./feeds/luci/applications/luci-app-wrtbwmon/luci-app-wrtbwmon/* ./feeds/luci/applications/luci-app-wrtbwmon
rm -rf ./feeds/luci/applications/luci-app-wrtbwmon/luci-app-wrtbwmon
