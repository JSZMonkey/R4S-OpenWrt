...
# qBittorrent 下载
svn co https://github.com/coolsnowwolf/luci/tree/master/applications/luci-app-qbittorrent package/new/luci-app-qbittorrent
svn co https://github.com/coolsnowwolf/packages/tree/master/net/qBittorrent-static package/new/qBittorrent-static
svn co https://github.com/coolsnowwolf/packages/tree/master/net/qBittorrent package/new/qBittorrent
svn co https://github.com/coolsnowwolf/packages/tree/master/libs/qtbase package/new/qtbase
svn co https://github.com/coolsnowwolf/packages/tree/master/libs/qttools package/new/qttools
svn co https://github.com/coolsnowwolf/packages/tree/master/libs/rblibtorrent package/new/rblibtorrent
