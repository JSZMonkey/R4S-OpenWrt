...
cp -f ./openwrt_back/include/kernel.mk ./openwrt_new/include/kernel.mk
cp -f ./openwrt_back/include/kernel-version.mk ./openwrt_new/include/kernel-version.mk
cp -f ./openwrt_back/include/toolchain-build.mk ./openwrt_new/include/toolchain-build.mk
cp -f ./openwrt_back/include/kernel-defaults.mk ./openwrt_new/include/kernel-defaults.mk
