...
#cp -f ../PATCH/BMQ/02-Fix-limited-cpufreq-for-schedutil.patch ./target/linux/generic/hack-5.4/694-02-Fix-limited-cpufreq-for-schedutil.patch
...
svn export https://github.com/JSZMonkey/OpenWrt-Add/trunk/luci-app-control-weburl package/new/luci-app-control-weburl
...
# Boost 通用即插即用
svn export https://github.com/QiuSimons/slim-wrt/branches/dev-21.02/slimapps/application/luci-app-boostupnp package/new/luci-app-boostupnp
...
svn export https://github.com/JSZMonkey/OpenWrt-Add/trunk/luci-app-dnsproxy package/new/luci-app-dnsproxy
